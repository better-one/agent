...
class SnakeGameV3:
    def __init__(self):
        ...
        pygame.display.set_caption("🐍 贪吃蛇 v3.1 - Bug 修复版")
        ...
        self.theme = Themes.get_theme(self.current_theme)  # 修复 Bug 2
    ...
    def switch_theme(self):
        themes_list = Themes.get_all_themes()  # 修复 Bug 2
    ...
    def draw_menu(self):
        ...
        subtitle = f"{self.theme['name']} v3.1"
